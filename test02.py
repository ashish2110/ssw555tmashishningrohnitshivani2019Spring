...
class TestProject(unittest.TestCase):
    ...
    incorrect_ind = {
        ...
        '@I2@': {'NAME': ['Sherley /Johnson/', 17], 'SEX': ['F', 21], 'BIRT_DATE': ['2000-02-25', 23], 'DEAT_DATE': ['NA', 25], 'FAMC': [['@F1@', 26]], 'ALIVE': 'True', 'FAMS': 'NA'}
        }
    ...
    def test_us02_birth_is_before_marriage(self):
        ...
        self.assertFalse(us02_birth_before_marriage(self.incorrect_ind,self.incorrect_family))
